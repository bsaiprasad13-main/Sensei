package com.example.sensei.widget
...
import com.example.sensei.MainActivity
import com.example.sensei.R
...
class SenseiWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_CLEAR || intent.action == ACTION_LIST_CLICK) {
            ...
            val thisWidget = ComponentName(context, SenseiWidgetProvider::class.java)
    ...
    companion object {
        const val ACTION_CLEAR = "com.example.sensei.WIDGET_CLEAR"
        const val ACTION_LIST_CLICK = "com.example.sensei.WIDGET_LIST_CLICK"
        ...
        internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_sensei)
            ...
            val listClickIntent = Intent(context, SenseiWidgetProvider::class.java).apply {
        ...
        private fun getPendingIntent(context: Context, action: String): PendingIntent {
            val intent = Intent(context, SenseiWidgetProvider::class.java).apply {
                this.action = action
            }
