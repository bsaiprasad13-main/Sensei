...
class StatusService : Service() {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = "Sensei Status Channel"
            val descriptionText = "Shows the currently active Sensei status"
    ...
    companion object {
        const val CHANNEL_ID = "sensei_status_channel"
