# Sensei: Missed Call Manager

Sensei is an Android application that acts as your personal auto-responder. When you are deep in work, working out, or simply taking a nap, Sensei protects your focus time while keeping your callers informed.
...
To install and run Sensei on your own Android device:
...
6. **Important:** Android heavily optimizes background apps. You must disable Battery Optimization for Sensei in your device settings for the service to run reliably.
